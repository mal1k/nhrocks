 ...
 *     @ORM\Index(name="listingtemplate_id", columns={"listingtemplate_id"}),
...
class Listing
{
     ...
     * @var ListingTemplate
     *
     * @ORM\ManyToOne(targetEntity="ArcaSolutions\ListingBundle\Entity\ListingTemplate", inversedBy="listings", fetch="EXTRA_LAZY", cascade={"persist"})
    ...
    /**
     * @param ListingTemplate $template
     * @return Listing
     */
    public function setTemplate(ListingTemplate $template)
    {
