...
class ListingLevel
{
     ...
     * @var string
     *
     * @ORM\Column(name="has_cover_image", type="string", length=1, nullable=true)
     */
    private $hasCoverImage = 'n';

    /**
     * @var string
     *
     * @ORM\Column(name="has_logo_image", type="string", length=1, nullable=true)
     */
    private $hasLogoImage = 'n';
    ...
    /**
     * @param string $hasCoverImage
     */
    public function setHasCoverImage($hasCoverImage)
    {
     ...
     * @return string
     */
    public function getHasLogoImage()
    {
        return $this->hasLogoImage;
    }

    /**
     * @param string $hasLogoImage
     */
    public function setHasLogoImage(string $hasLogoImage)
    {
        $this->hasLogoImage = $hasLogoImage;
    }
