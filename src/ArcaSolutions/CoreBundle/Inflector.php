...
class Inflector
{
     ...
     * @param   bool $lowercase lowercare string and upper case first
    ...
    {
        return Str::lower(preg_replace('/([A-Z]+)([A-Z])/', '\1_\2',
            preg_replace('/([a-z\d])([A-Z])/', '\1_\2', strval($camel_cased_word))));
    }
