                    ...
                    <div class="checkbox-inline">
                        <label>
                            ...
                            <?= ucwords(system_showText(LANG_SITEMGR_SETTINGS_GEOIP_ENABLE)) ?>&nbsp;<a
                                href="https://support.edirectory.com/customer/portal/articles/2976879-edirectory-geo-ip-location?b_id=7909"
            ...
            for ($i = 1; $i <= 5; $i++) {
                ...
                <tr>
                    ...
                    <td class="form-group-table text-center">
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="text" placeholder="<?= system_showText(constant('LANG_SITEMGR_LABEL_'.constant('LOCATION'.$i.'_SYSTEM'))) ?>" class="form-control" name="location_<?= $i ?>_label" value="<?=(constant('LOCATION_'.$i.'_NAME'))?>" maxlength="15" onblur="this.value = this.value.replace(/^\s+|\s+$/g, '');" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" placeholder="<?= system_showText(constant('LANG_SITEMGR_LABEL_'.constant('LOCATION'.$i.'_SYSTEM').'_PL')) ?>" class="form-control" name="location_<?= $i ?>_label_plural" value="<?=(constant('LOCATION_'.$i.'_NAME_PLURAL'))?>" maxlength="15" onblur="this.value = this.value.replace(/^\s+|\s+$/g, '');" required>
                            </div>
                        </div>
                    </td>
