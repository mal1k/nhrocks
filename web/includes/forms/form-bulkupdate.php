...
?>
    ...
    <form class="bulkupdate" name="form-bulk" id="form-bulk" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post">
        ...
        if (!in_array($bulkType, ["review", "article", "promotion", "blog", "banner", "nearbySearch"])  && $allowLevel) { ?>
        ...
        if (!in_array($bulkType, ["review", "promotion", "nearbySearch"]) && $allowStatus) { ?>
			<div class="col-md-2 col-xs-3 visible-lg">
        ...
        if ( !in_array($bulkType, ["review", "blog", "promotion", "nearbySearch"]) && $allowRenewalDate) { ?>
			<div class="col-md-2 col-xs-3 visible-lg">
