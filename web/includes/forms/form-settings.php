    ...
    <div class="col-md-10">
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <button type="submit" id="btn-maintenance" name="maintenance" value="maintenance" class="btn btn-primary action-save"
                        data-loading-text="<?= system_showText(LANG_LABEL_FORM_WAIT); ?>"><?= system_showText(LANG_SITEMGR_SAVE_CHANGES); ?></button>
                <a data-mixpanel-event='Clicked on button "Customize Maintenance Page" from General Settings section' href="<?= DEFAULT_URL."/".SITEMGR_ALIAS."/design/page-editor/custom.php?id=".$idMaintance["id"] ?>"
                   target="_blank"
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="checkbox">
                            <label for="listing_login_review">
                                <input type="checkbox" id="listing_login_review" name="listing_login_review" value="on" <?= $listing_login_review == 'on' ? 'checked' : '' ?>>
                    ...
                    <div class="col-sm-9 col-sm-offset-3 checkbox">
                        ...
                        <div class="checkbox">
                            <label for="socialnetwork_feature">
                                <input type="checkbox" id="socialnetwork_feature" name="socialnetwork_feature" value="on" <?= $socialnetwork_feature == 'on' ? 'checked' : '' ?>>
