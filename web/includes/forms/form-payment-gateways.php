		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<div id="wrap-pagseguro" class="<?= ($gatewayInfo['pagseguro']['payment_pagseguroStatus'] == "on" ? '' : "hidden" )?>">
                    ...
                    <div class="form-group col-sm-9 col-sm-offset-3">
                        <p class="alert alert-warning">Precisa de ajuda para configurar sua integração com o PagSeguro? Clique <a target="_blank" rel="noopener noreferrer" href="http://support.edirectory.com/customer/en/portal/articles/2966518-como-habilitar-o-pagseguro-no-seu-diret%C3%B3rio-?b_id=7909">aqui</a>.</p>
                    </div>
				</div>
			</div>
