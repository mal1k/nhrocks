...
?>
    ...
    <div class="col-md-7">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <input class="form-control" type="text" name="price" id="price" value="<?=$price?>" placeholder="00.00" <?=PAYMENTSYSTEM_FEATURE === 'off' ? 'disabled' : ''?>/>
                    </div>
                </div>
            </div>
        ...
        <?php
        /* ModStores Hooks */
        HookFire("formlistingtype_after_render_longdescriptionfields", [
            "id" => &$id
        ]);
        ?>
