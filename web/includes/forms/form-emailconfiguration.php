    ...
    <div id="form-smtp" class="panel panel-default">
        ...
        <div class="panel-body form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="emailconf_host" id="host" value="<?= $domainConfig['mailer_host'] ?>" <?= $styleButtonChange ?>>
                </div>
                <label for="port" class="control-label col-sm-2"><?= system_showText(LANG_SITEMGR_SETTINGS_EMAILCONF_LABEL_PORT) ?></label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="emailconf_port" id="port" value="<?= $domainConfig['mailer_port'] ?>" <?= $styleButtonChange ?>>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <div class="radio">
                        <label for="auth1">
                            <input type="radio" name="emailconf_auth" id="auth1" value="plain" <?= $domainConfig['mailer_auth_mode'] === 'plain' ? 'checked=checked' : '' ?> <?= $styleButtonClick ?>><?= system_showText(LANG_SITEMGR_SETTINGS_EMAILCONF_SERVERREQUIRESAUTHENTICATION1) ?>
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-offset-3 col-sm-7">
                    <div class="radio">
                        <label for="auth2" class="row col-sm-12">
                            <div class="col-sm-10">
                                <input type="radio" name="emailconf_auth" id="auth2" value="login" <?= $domainConfig['mailer_auth_mode'] === 'login' ? 'checked=checked' : '' ?> <?= $styleButtonClick ?>><?= system_showText(LANG_SITEMGR_SETTINGS_EMAILCONF_SERVERREQUIRESAUTHENTICATION2) ?>
                            </div>
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <div class="radio">
                        <label for="auth3">
                            <input type="radio" name="emailconf_auth" id="auth3" value="noauth" <?= $domainConfig['mailer_auth_mode'] === null ? 'checked=checked' : '' ?> <?= $styleButtonClick ?>><?= system_showText(LANG_SITEMGR_SETTINGS_EMAILCONF_SERVERREQUIRESAUTHENTICATION3) ?>
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div id="email_group">
                        <input type="text" class="form-control" name="emailconf_email" id="email" value="<?= $domainConfig['mailer_sender'] ?>" onkeyup="emailChange(this.value)" onkeypress="emailChange(this.value)" onblur="emailBlur(this.form)" <?= $styleButtonChange ?>>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="emailconf_username" id="username" value="<?= $domainConfig['mailer_user'] ?>" <?= $styleButtonChange ?>>
                </div>
            </div>
            <div class="form-group">
