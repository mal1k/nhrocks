...
?>
    ...
    <section class="row type-choice hidden">
        ...
        <div class="form-thumbnails">
            ...
            <p><?=str_replace("[a]", "<a id='listingtype_id' href=\"".DEFAULT_URL."/".SITEMGR_ALIAS."/content/listing-types/\" target=\"_blank\">",str_replace("[/a]", "</a>", system_showText(LANG_SELECT_LISTINGTEMPLATE_TIP)));?></p>
            <br>
            <div class="row">
                ...
                <div class="col-md-2 col-xs-6">
                    <div class="thumbnail typeSelect">
                        <div class="caption">
                            ...
                            <button type="button" id="listingtype_option" class="btn btn-default btn-xs" onclick="selectType($(this), <?=$rowLT["id"];?>);"><?=system_showText(LANG_LABEL_SELECT);?></button>
                        </div>
                    </div>
                </div>
                <? } ?>
