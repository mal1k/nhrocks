<?
    ...
    */
    ...
    <div class="col-md-<?=($fullWidth ? '12' : '7')?>">
                ...
                <div class="panel panel-form-media">
                    ...
                    <div class="panel-body" id="categoryImageContainer">
                        ...
                        if ($image_id) {
                            ...
                            if ($imageObj->imageExists()) { ?>
                                <?=$imageObj->getTag(true, IMAGE_CATEGORY_FULL_WIDTH, IMAGE_CATEGORY_FULL_HEIGHT, $title, false, false,
                                    'img-responsive');?>
                            <? }
                        } ?>
                    ...
                    <div class="panel-footer text-center">
                        <p class="small text-muted">
                            <?= system_showText(LANG_LABEL_RECOMMENDED_DIMENSIONS); ?>
                            : <?= IMAGE_CATEGORY_FULL_WIDTH ?> x <?= IMAGE_CATEGORY_FULL_HEIGHT ?>
                        </p>
                        <p class="small text-muted">
                            <?= system_showText(LANG_MSG_MAX_FILE_SIZE) ?> <?= UPLOAD_MAX_SIZE; ?> MB.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="panel-heading">
                        ...
                        <small class="text-muted">
                            (<?=ICON_CATEGORY_WIDTH;?>px x <?=ICON_CATEGORY_HEIGHT;?>px)
                        </small>
                    </div>

                    <div class="panel-body" id="categoryIconContainer">

                        <?
                        if ($icon_id) {
                            $imageObj = new Image($icon_id);
                            if ($imageObj->imageExists()) { ?>
                                <?=$imageObj->getTag(true, ICON_CATEGORY_WIDTH, ICON_CATEGORY_HEIGHT, $title, false, false,
                                    'img-responsive');?>
                            <? }
                        } ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-10">
                                <input type="file" class="file-withinput" name="icon" id="icon" size="50">
                            </div>
                            <?php if ($icon_id) { ?>
                                <div class="col-xs-12 col-sm-2">
                                    <button type="button" class="btn btn-sm btn-danger delete pull-right iconImageDeleteButton" data-module="<?= $table_category ?>" data-id="<?= $id ?>">
                                        <i class="icon-ion-ios7-trash-outline"></i>
                                    </button>
                                </div>
                            <?php } ?>
