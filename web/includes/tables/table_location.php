<?
    ...
    if ($operation) {
        if ($operation == "insert") { ?>
            <div id="warning" class="alert alert-success"><?=string_ucwords(constant("LANG_LABEL_".constant("LOCATION".$_location_level."_SYSTEM")))." ".$_GET["loc_name"]." ".system_showText(LANG_SITEMGR_LOCATION_WASSUCCESSADDED);?></div>
            <?
        } else
        if ($operation == "update") { ?>
            <div id="warning" class="alert alert-success"><?=string_ucwords(constant("LANG_LABEL_".constant("LOCATION".$_location_level."_SYSTEM")))." ".$_GET["loc_name"]." ".system_showText(LANG_SITEMGR_LOCATION_WASSUCCESSUPDATED);?></div>
            <?
        } else
        if ($operation == "delete") { ?>
            <div id="warning" class="alert alert-success"><?=string_ucwords(constant("LANG_LABEL_".constant("LOCATION".$_location_level."_SYSTEM")))." ".$_GET["loc_name"]." ".system_showText(LANG_SITEMGR_LOCATION_WASSUCCESSDELETED);?></div>
            <?
        }
    }
