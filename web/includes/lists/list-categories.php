        ...
        <ul class="list-content-item no-bulk tree">
            ...
            <li class="content-item-noview">
                ...
                <div class="tree-content">
                    ...
                    <?php
                    /* ModStores Hooks */
                    HookFire( "listcategory_before_render_subcategoriesbutton", [
                    ...
                    <div class="item">
                        ...
                        <p>
                            ...
                            <?php
                            /* ModStores Hooks */
                            HookFire( "listcategory_before_render_subcategoriescounter", [
                                "maxLevelCat" => &$maxLevelCat,
                            ]);
                            ...
                            <span class="btn-group btn-group-xs">
                                ...
                                <?php
                                /* ModStores Hooks */
                                HookFire( "listcategory_before_render_addsubcategoriesbutton", [
                                    "maxLevelCat" => &$maxLevelCat,
                                ]);
