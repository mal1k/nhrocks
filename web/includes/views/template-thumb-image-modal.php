...
# ----------------------------------------------------------------------------------------------------
# * FILE: /includes/views/template-thumb-image-modal.php
# ----------------------------------------------------------------------------------------------------
...
<script type="text/template" id="template-photo">
    <div class="unsplash-item" id="%id%">
        <a href="javascript:;" class="unsplash-picture thumb-image-modal" data-download="%download_location%" data-regular="%regular%">
