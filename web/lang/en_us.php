<?php
	...
	define("LANG_HOURS_WORK_START_LESS_END", "The end time field can not be less than the start time field.");
    //The week day field can not be empty.
    define("LANG_HOURS_WORK_NEED_WEEK_DAY", "The week day field can not be empty.");
    //The hours field can not be empty.
    define("LANG_HOURS_WORK_NEED_HOURS", "The hours field can not be empty.");
	//Account Information
