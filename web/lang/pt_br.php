<?php
	...
	define("LANG_CLAIM_ALERTMEDIA", "Algumas informações de sua empresa, como a imagem da capa, galeria de imagens, vídeo, arquivo adicional e classificações, estarão disponíveis apenas para edição após a aprovação do pedido de reivindicação.");
	//Claim this Listing
    ...
    define("LANG_TYPE_THE_LISTING_NAME_FOR_SUGGESTIONS", "Digite o nome da Empresa para sugestões");
    ...
    define("LANG_SITEMGR_SETTINGS_LEVELS_ITEMTIP_CLASSIFIED_ASSOCIATION", "Quantos classificados um proprietário pode associar à sua empresa?");
    ...
    //List with us
    define("LANG_LIST_WITH_US", "Listar conosco");
    //Icon
