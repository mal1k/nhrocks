    ...
    */
    ...
    <?php } else {
        ...
        <main class="wrapper togglesidebar container-fluid">
            ...
            <form role="form" name="blog" id="blog" action="<?= system_getFormAction($_SERVER["PHP_SELF"]) ?>"
                ...
                <section class="row heading">
                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-8">
                            <? if ($id) { ?>
                                <h1><?= string_ucwords(system_showText(LANG_SITEMGR_EDIT))." ".system_showText(LANG_BLOG) ?>
                                    <i><?= $post->getString("title") ?></i></h1>
                            <? } else { ?>
