            ...
            <form role="form" name="listing" id="listing" action="<?= system_getFormAction($_SERVER['PHP_SELF']) ?>"
                ...
                <section class="row heading">
                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-8">
                            <? if ($id) { ?>
                                <h1><?= string_ucwords(system_showText(LANG_SITEMGR_EDIT)).' '.system_showText(LANG_SITEMGR_LISTING_SING) ?>
                                    <i><?= $listing->getString('title') ?></i></h1>
                            <? } else { ?>
                        ...
                        <div class="col-sm-4 text-right  hidden-xs hidden-sm">
                            ...
                            <a href="javascript:void(0);" data-tour
                               class="text-info tutorial-text"><?= system_showText(LANG_LABEL_TUTORIAL); ?> <i
                                        class="icon-help8"></i></a>
                        </div>
