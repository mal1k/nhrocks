    ...
    */
    ...
    <?php } else {
        ...
        <main class="wrapper togglesidebar container-fluid">
            ...
            <form role="form" name="promotion" id="promotion" action="<?= system_getFormAction($_SERVER["PHP_SELF"]) ?>"
                ...
                <section class="row heading">
                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-8">
                            <? if ($id) { ?>
                                <h1><?= string_ucwords(system_showText(LANG_SITEMGR_EDIT))." ".system_showText(LANG_SITEMGR_PROMOTION_SING) ?>
                                    <i><?= $promotion->getString("name") ?></i></h1>
                            <? } else { ?>
                ...
                <section class="row tab-options">
                    ...
                    <div class="container">
                        <div class="pull-right top-actions">
                            <a href="<?= DEFAULT_URL."/".SITEMGR_ALIAS."/content/".PROMOTION_FEATURE_FOLDER."/" ?>"
                            ...
                            <button type="button" name="submit_button" value="Submit"
                                    onclick="document.promotion.submit();" class="btn btn-primary action-save"
