...
mixpanel_track(($id ? "Edited an existing listing type" : "Added a new listing type"));
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (validate_listingtemplate($_POST, $message_listingtemplate)) {
        ...
        /* ModStores Hooks */
        HookFire("listingtypes_after_save", [
...
if ($id) {
    ...
    /* ModStores Hooks */
    HookFire("listingtypes_after_fill_formdata", [
        "listingtemplate" => &$listingtemplate,
    ]);
}
...
/* ModStores Hooks */
HookFire("listingtypes_after_setup_form", [
    "listingtemplate" => &$listingtemplate,
]);
