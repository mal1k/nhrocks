        ...
        <div class="second-sidebar">
            ...
            <div class="navigation nano">
                <div class="list-group nano-content">
                    ...
                    <?php
                    /* ModStores Hooks */
                    HookFire( "sidebardesign_after_render_pageeditor");
                    ?>
                    ...
                    <?php
                    /* ModStores Hooks */
                    HookFire( "sidebardesign_after_render_themes");
                    ?>
                    ...
                    <?php /* ModStores Hooks */
                    HookFire( "sidebardesign_after_render_colorsfonts");
                    ?>
                    ...
                    <?php
                    /* ModStores Hooks */
                    HookFire( "sidebardesign_after_render_csseditor");
                    ?>
                    ...
                    <?php
                    /* ModStores Hooks */
                    HookFire( "sidebardesign_after_render_emaileditor");
                    ?>
