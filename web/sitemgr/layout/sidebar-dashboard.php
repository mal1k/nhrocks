        ...
        <div class="main-sidebar nano">
            <ul class="nav nav-pills nav-stacked nano-content">
                ...
                <li class="branding-message">
                    <?=system_showText(LANG_POWEREDBY)?> <a href="http://www.edirectory.com<?=(string_strpos($_SERVER["HTTP_HOST"], ".com.br") !== false ? ".br" : "")?>" target="_blank" rel="nofollow">eDirectory Cloud Service</a>&trade; <?=$symfonyKernel::VERSION?>. &copy; Arca Solutions Inc.
                </li>
                <? } else { ?>
                <li class="unbranded-message">
