        ...
        <div class="second-sidebar">
            ...
            <div class="navigation nano">
                <div class="list-group nano-content">
                    ...
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/promote/mailing-list/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/promote/mailing-list") !== false ? "active" : "")?>"><?=system_showText(LANG_SITEMGR_MAILINGLIST);?></a>
                    <? } ?>
