...
<main class="wrapper-dashboard togglesidebar container-fluid">
    ...
    <section class="heading">
        <h1>Crontab</h1>
        <p>
            Please, be aware that <i>cron_manager.php</i> runs others crons indicated below. If you schedule
            cron_manager, <strong>DO NOT SCHEDULE</strong> any other cron that cron_manager runs.<br/>
            If you need to schedule any cron separately and still keep cron_manager scheduled, go to the file
            cron/cron_manager.php and comment the line that corresponds to the cron you want to run separately.
        </p>
    </section>
    ...
    <section class="row section-form">
        <div class="form-group col-lg-6">
            ...
            <textarea class="form-control" name="text" id="textarea"
                      rows="8"><?= htmlspecialchars($cronTabText) ?></textarea>
        </div>

        <div class="form-group col-lg-6">
            <h3>Crontab <strong>with cron manager</strong></h3>
            <textarea class="form-control" name="text" id="textarea"
                      rows="8"><?= htmlspecialchars($cronTabText2) ?></textarea>
        </div>
    </section>
    <section class="row section-form">
        <div class="col-sm-12">
