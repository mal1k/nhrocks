<?
    ...
    */
    ...
    mixpanel_track("Accessed Leads section", ["Module" => ucfirst($item_type)]);
        ...
        <div class="row tab-options">
            <ul role="tablist" class="nav nav-tabs">
                ...
                <li class="<?=($item_type == "listing" ? "active" : "")?>">
                    <a data-mixpanel-event='Clicked on tab "Listings" from Leads section' href="<?=$url_redirect?>/" role="tab"><?=system_showText(LANG_SITEMGR_LISTING_LEADS)?></a>
                </li>

                <? if (EVENT_FEATURE == "on" && CUSTOM_EVENT_FEATURE == "on") { ?>
                <li class="<?=($item_type == "event" ? "active" : "")?>">
                    <a data-mixpanel-event='Clicked on tab "Events" from Leads section' href="<?=$url_redirect?>/?item_type=event" role="tab"><?=system_showText(LANG_SITEMGR_EVENT_LEADS)?></a>
                </li>
                <? } ?>

                <? if (CLASSIFIED_FEATURE == "on" && CUSTOM_CLASSIFIED_FEATURE == "on") { ?>
                <li class="<?=($item_type == "classified" ? "active" : "")?>">
                    <a data-mixpanel-event='Clicked on tab "Classifieds" from Leads section' href="<?=$url_redirect?>/?item_type=classified" role="tab"><?=system_showText(LANG_SITEMGR_CLASSIFIED_LEADS)?></a>
                </li>
                <? } ?>

                <li class="<?=($item_type == "general" ? "active" : "")?>">
                    <a data-mixpanel-event='Clicked on tab "General" from Leads section' href="<?=$url_redirect?>/?item_type=general" role="tab"><?=system_showText(LANG_SITEMGR_GENERAL_LEADS)?></a>
                </li>
            </ul>
