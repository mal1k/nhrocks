<?php
    ...
    */
    ...
    mixpanel_track("Accessed Traffic Overview section");
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <section class="well well-intro">
            ...
            <div class="row">
                ...
                <? if ((CREDITCARDPAYMENT_FEATURE === 'on' || PAYMENT_INVOICE_STATUS === 'on' || PAYMENT_MANUAL_STATUS === 'on') && PAYMENTSYSTEM_FEATURE === 'on') { ?>
                    <div class="col-sm-1 col-xs-3 text-center">
