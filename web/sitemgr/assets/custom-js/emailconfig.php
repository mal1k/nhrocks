...
?>
	<script>
        ...
        radiovalues = {'plain' : 1, 'login' : 2, 'noauth' : 3};
        ...
        function switchAuth(auth) {
            var array_default_ports = ['25', '465', '587'];
        ...
        function doVerifyConnect_onload(data, textStatus) {
            ...
            if (textStatus == 'success') {
                if (data.status == 'success') {
                    MixpanelHelper.track('SMTP Server connection success')
                    ...
                    MixpanelHelper.track('SMTP Server connection failed')
