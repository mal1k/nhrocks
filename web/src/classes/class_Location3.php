...
class Location3 extends Handle
{
    ...
    public function __construct($var = '')
    {
        ...
        /* ModStores Hooks */
        HookFire("classlocation3_contruct", [
            "that" => &$this
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation3_before_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation3_after_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation3_before_preparesave", [
            "that" => &$this
        ]);
        ...
        if ($this->id) {
            $sql = "UPDATE `Location_3` l3
                    ...
                    SET
                        ...
                        l3.location_2      = {$this->location_2},
                        l3.name            = {$this->name},
                        l3.abbreviation    = {$this->abbreviation},
                        l3.friendly_url    = {$this->friendly_url},
                        l3.page_title      = {$this->page_title},
                        l3.seo_description = {$this->seo_description},
                        l3.seo_keywords    = {$this->seo_keywords},
                        l3.latitude        = {$this->latitude},
                        l3.longitude       = {$this->longitude},
                        l3.radius          = {$this->radius},
            ...
            /* ModStores Hooks */
            HookFire("classlocation3_before_updatequery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation3_after_updatequery", [
                "that" => &$this
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation3_before_insertquery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation3_after_insertquery", [
                "that"  => &$this,
                "dbObj" => &$dbObj,
            ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation3_before_prepareuse", [
            "that" => &$this
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation3_after_save", [
            "that" => &$this
        ]);
    }
    ...
    function Delete($updFullText = false, $updateOnElasticsearch = true)
    {
        if ($this->id) {
            ...
            /* ModStores Hooks */
            HookFire("classlocation3_before_delete", [
                "that" => &$this
            ]);
