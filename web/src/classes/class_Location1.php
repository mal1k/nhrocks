...
class Location1 extends Handle
{
    ...
    public function __construct($var = '')
    {
        ...
        /* ModStores Hooks */
        HookFire("classlocation1_contruct", [
            "that" => &$this
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation1_before_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation1_after_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation1_before_preparesave", [
            "that" => &$this
        ]);
        ...
        if ($this->id) {
            ...
            /* ModStores Hooks */
            HookFire("classlocation1_before_updatequery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation1_after_updatequery", [
                "that" => &$this
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation1_before_insertquery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation1_after_insertquery", [
                "that"  => &$this,
                "dbObj" => &$dbObj,
            ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation1_before_prepareuse", [
            "that" => &$this
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation1_after_save", [
            "that" => &$this
        ]);
    }
    ...
    function Delete($updFullText = false, $updateOnElasticsearch = true)
    {
        if ($this->id) {
            ...
            /* ModStores Hooks */
            HookFire("classlocation1_before_delete", [
                "that" => &$this
            ]);
