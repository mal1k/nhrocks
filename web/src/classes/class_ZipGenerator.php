<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /classes/class_zipGenerator.php
	# ----------------------------------------------------------------------------------------------------
	...
	class zipGenerator  {  
		...
		function forceDownload($archiveName) {
			...
			// Security checks
			if( $archiveName == "" ) {
				echo "<html><title>".EDIRECTORY_TITLE." - Download </title><body><br /><B>ERROR:</B> The download file was NOT SPECIFIED.</body></html>";
				exit;
			} 
			elseif ( ! file_exists( $archiveName ) ) {
				echo "<html><title>".EDIRECTORY_TITLE." - Download </title><body><br /><B>ERROR:</B> File not found.</body></html>";
				exit;
			}
