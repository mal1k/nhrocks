...
class Location4 extends Handle
{
    ...
    public function __construct($var = '')
    {
        ...
        /* ModStores Hooks */
        HookFire("classlocation4_contruct", [
            "that" => &$this
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation4_before_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation4_after_makerow", [
            "that" => &$this,
            "row"  => &$row,
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire("classlocation4_before_preparesave", [
            "that" => &$this
        ]);
        ...
        if ($this->id) {
            $sql = "UPDATE `Location_4` l4
                    LEFT JOIN `Location_5` l5 ON l4.id = l5.location_4
                    SET
                        l4.location_1      = {$this->location_1},
                        l4.location_2      = {$this->location_2},
                        l4.location_3      = {$this->location_3},
                        l4.name            = {$this->name},
                        l4.abbreviation    = {$this->abbreviation},
                        l4.friendly_url    = {$this->friendly_url},
                        l4.page_title      = {$this->page_title},
                        l4.seo_description = {$this->seo_description},
                        l4.seo_keywords    = {$this->seo_keywords},
                        l4.latitude        = {$this->latitude},
                        l4.longitude       = {$this->longitude},
                        l4.radius          = {$this->radius},
                        l5.location_1      = {$this->location_1},
                        l5.location_2      = {$this->location_2},
                        l5.location_3      = {$this->location_3}
                    WHERE l4.`id` = {$this->id}";

            /* ModStores Hooks */
            HookFire("classlocation4_before_updatequery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation4_after_updatequery", [
                "that" => &$this
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation4_before_insertquery", [
                "that" => &$this,
                "sql"  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire("classlocation4_after_insertquery", [
                "that"  => &$this,
                "dbObj" => &$dbObj,
            ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation4_before_prepareuse", [
            "that" => &$this
        ]);
        ...
        /* ModStores Hooks */
        HookFire("classlocation4_after_save", [
            "that" => &$this
        ]);
    }
    ...
    function Delete($updFullText = false, $updateOnElasticsearch = true)
    {
        if ($this->id) {
            ...
            /* ModStores Hooks */
            HookFire("classlocation4_before_delete", [
                "that" => &$this
            ]);
