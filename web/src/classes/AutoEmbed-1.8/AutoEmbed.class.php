...
class AutoEmbed {
  ...
  public function getImageURL() {
    ...
    for ($i=1, $iMax = count($this->_media_id); $i<= $iMax; $i++) {
  ...
  private function _buildiFrame() {
    ...
    return sprintf('<iframe class="embed-responsive-item" width="%s" height="%s" src="%s" allowfullscreen></iframe>', $width, $height, $source);
  }
