...
class ArticleCategory extends Handle
{
    ...
    public function __construct($var = '')
    {
        ...
        /* ModStores Hooks */
        HookFire('classarticlecategory_contruct', [
            'that' => &$this
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire('classarticlecategory_before_makerow', [
            'that' => &$this,
            'row'  => &$row,
        ]);
        ...
        /* ModStores Hooks */
        HookFire('classarticlecategory_after_makerow', [
            'that' => &$this,
            'row'  => &$row,
        ]);
    }
    ...
    {
        /* ModStores Hooks */
        HookFire('classarticlecategory_before_preparesave', [
            'that' => &$this
        ]);
        ...
        if ($this->id) {
            ...
            /* ModStores Hooks */
            HookFire('classarticlecategory_before_updatequery', [
                'that' => &$this,
                'sql'  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire('classarticlecategory_after_updatequery', [
                'that' => &$this
            ]);
            ...
            /* ModStores Hooks */
            HookFire('classarticlecategory_before_insertquery', [
                'that' => &$this,
                'sql'  => &$sql,
            ]);
            ...
            /* ModStores Hooks */
            HookFire('classarticlecategory_after_insertquery', [
                'that'  => &$this,
                'dbObj' => &$dbObj,
            ]);
        ...
        /* ModStores Hooks */
        HookFire('classarticlecategory_before_prepareuse', [
            'that' => &$this
        ]);
        ...
        /* ModStores Hooks */
        HookFire('classarticlecategory_after_save', [
            'that' => &$this
        ]);
    }
    ...
    public function Delete()
    {
        if ($this->id != 0) {
            ...
            /* ModStores Hooks */
            HookFire('classarticlecategory_before_delete', [
                'that' => &$this
            ]);
