<?php
 ...
 ?>
    <header class="header" data-type="4" is-sticky="<?=$widgetContent['stickyMenu'] === 'true' ? 'true' : 'false' ?>" is-inverse="<?=$widgetContent['backgroundColor'] === 'base' ? 'true' : 'false'?>" has-opacity="<?=$widgetContent['isTransparent'] === 'true' ? 'true' : 'false' ?>" has-mod="<?HookFire("header_check_dropdown")?>">
